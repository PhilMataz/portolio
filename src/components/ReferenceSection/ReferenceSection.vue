<template>
  <section class="pt-12 pb-24 max-w-screen-lg mx-auto flex flex-col items-center px-2 lg:px-0">
    <BaseSectionHeader>
      Don't just take my word for it
      <template #sub-header>Hear from those who've experienced my craft firsthand.</template>
    </BaseSectionHeader>
